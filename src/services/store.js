...
export const createReport = (data) => {
  return request('post', '/intelligence/api/collectFolderNewsReport/createReport', {
    config: {
      data: data,
    }
  })
...
// 报告列表
export const queryPageTable = (data) => {
  return request('post', '/intelligence/api/collectFolderNewsReport/queryPage', {
    config: {
      data: data,
    }
  })
...
export const deleteReport = (data) => {
  return request('post', '/intelligence/api/collectFolderNewsReport/deleteReport', {
    config: {
      data: data,
    }
  })
...
// 导出报告
export const exportReportToWord = (data) => {
  return request('get', '/intelligence/api/collectFolderNewsReport/exportReportToWord', {
    params: data,
    config: {
      responseType: "blob",
      headers: { 'content-type': 'application/json;charset=UTF-8' }
...
// ---------------------------系统日志 ----------------------------
export const userLogs = (data) => {
  return request('post', '/intelligence/api/user/queryLogPage', {
    config: {
      data: data,
    }
  })
...
export const userPage = (data) => {
  return request('post', '/intelligence/api/user/queryUserPage', {
    config: {
      data: data,
    }
  })
...
export const userAdd = (data) => {
  return request('post', '/intelligence/api/user/save', {
    config: {
      data: data,
    }
  })
...
export const userinfo = (data) => {
  return request('post', '/intelligence/api/user/info', {
    config: {
      data: data,
    }
  })
...
export const userUpdate = (data) => {
  return request('post', '/intelligence/api/user/update', {
    config: {
      data: data,
    }
  })
...
export const userDelete = (data) => {
  return request('post', '/intelligence/api/user/delete', {
    config: {
      data: data,
    }
  })
...
export const userResetPassword = (data) => {
  return request('post', '/intelligence/api/user/resetPassword', {
    config: {
      data: data,
    }
  })
...
export async function getUserList() {
  return request('get', '/intelligence/api/user/list');
}

// 保存权限配置
export async function saveViewPermission(params) {
  return request('/intelligence/api/user/saveViewPermission', {
    method: 'POST',
    data: params,
  });
}
...
// ---------------------------专业术语管理----------------------------
export const wordPage = (data) => {
  return request('post', '/intelligence/api/word/queryWordPage', {
    config: {
      data: data,
    }
  })
...
export const wordAdd = (data) => {
  return request('post', '/intelligence/api/word/save', {
    config: {
      data: data,
    }
  })
...
export const wordinfo = (data) => {
  return request('post', '/intelligence/api/word/info', {
    config: {
      data: data,
    }
  })
}
export const wordUpdate = (data) => {
  return request('post', '/intelligence/api/word/update', {
    config: {
      data: data,
    }
  })
}
export const wordDelete = (data) => {
  return request('post', '/intelligence/api/word/delete', {
    config: {
      data: data,
    }
  })
